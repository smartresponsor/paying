 ...
 */
final readonly class PaymentPayPalProvider implements PaymentProviderInterface
{
    public function __construct(private PaymentPayPalGateway $gateway)
    {
    }
    ...
    public function refund(Ulid $id, string $amount): PaymentEntity
    {
        ...
        return new PaymentEntity($id, PaymentStatus::refunded, $amount, $currency)->withProviderRef($providerRef);
    }
    ...
    {
        return new PaymentEntity($id, PaymentStatus::processing, '0.00', 'USD')->withProviderRef('paypal_reconcile_'.$id);
    }
