 ...
 */
readonly class PaymentProviderGuard implements PaymentProviderGuardInterface
{
    public function __construct(
        private PaymentProviderRouterInterface $router,
        private PaymentRetryExecutorInterface $retry,
        private PaymentCircuitBreakerInterface $breaker,
        private PaymentMetricInterface $metric,
    ) {
    }
