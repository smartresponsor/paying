 ...
 */
final readonly class PaymentApiRequestValidator implements PaymentApiRequestValidatorInterface
{
    public function __construct(
        private ValidatorInterface $validator,
        private PaymentValidationErrorMapperInterface $validationErrorMapper,
    ) {
    }
