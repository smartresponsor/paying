...
{
    public function __construct(private readonly Metric $metric, private readonly Connection $data) { parent::__construct(); }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            if (function_exists('strtotime')) {
                ...
                if ($lagMs > 5000) { $output->writeln('projection_lag_ms '.$lagMs); return Command::FAILURE; }
            }
        } catch (\Throwable $e) {}
