...
class getConsole_CommandLoaderService extends App_KernelTestContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Command\\PaymentE2eDemoCommand' => ['privates', '.App\\Command\\PaymentE2eDemoCommand.lazy', 'getPaymentE2eDemoCommand_LazyService', true],
            'App\\Command\\PaymentOutboxProcessCommand' => ['privates', '.App\\Command\\PaymentOutboxProcessCommand.lazy', 'getPaymentOutboxProcessCommand_LazyService', true],
            'App\\Infrastructure\\Console\\DlqReplayCommand' => ['privates', '.App\\Infrastructure\\Console\\DlqReplayCommand.lazy', 'getDlqReplayCommand_LazyService', true],
            'App\\Infrastructure\\Console\\GateSloCommand' => ['privates', '.App\\Infrastructure\\Console\\GateSloCommand.lazy', 'getGateSloCommand_LazyService', true],
            'App\\Infrastructure\\Console\\IdemPurgeCommand' => ['privates', '.App\\Infrastructure\\Console\\IdemPurgeCommand.lazy', 'getIdemPurgeCommand_LazyService', true],
            'App\\Infrastructure\\Console\\OutboxRunCommand' => ['privates', '.App\\Infrastructure\\Console\\OutboxRunCommand.lazy', 'getOutboxRunCommand_LazyService', true],
            ...
            'App\\Infrastructure\\Console\\ProjectionRebuildCommand' => ['privates', '.App\\Infrastructure\\Console\\ProjectionRebuildCommand.lazy', 'getProjectionRebuildCommand_LazyService', true],
            'App\\Infrastructure\\Console\\ProjectionSyncCommand' => ['privates', '.App\\Infrastructure\\Console\\ProjectionSyncCommand.lazy', 'getProjectionSyncCommand_LazyService', true],
            'App\\Infrastructure\\Console\\ReconcileRunCommand' => ['privates', '.App\\Infrastructure\\Console\\ReconcileRunCommand.lazy', 'getReconcileRunCommand_LazyService', true],
            'App\\Infrastructure\\Console\\SlaReportCommand' => ['privates', '.App\\Infrastructure\\Console\\SlaReportCommand.lazy', 'getSlaReportCommand_LazyService', true],
            ...
            'App\\Infrastructure\\Console\\PaymentLifecycleCommand' => 'App\\Infrastructure\\Console\\PaymentLifecycleCommand',
