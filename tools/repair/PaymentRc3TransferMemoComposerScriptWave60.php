...
$composer['scripts']['report:rc3-transfer-memo'] = '@php tools/php/php84.php tools/inspection/PayingRc3TransferMemoReport.php';
...
echo "Registered composer script: report:rc3-transfer-memo\n";
