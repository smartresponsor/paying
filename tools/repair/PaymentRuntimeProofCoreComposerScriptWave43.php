...
$composer['scripts']['report:runtime-proof-core'] = '@php tools/php/php84.php tools/inspection/PayingRuntimeProofCoreReport.php';
...
echo "Registered composer script: report:runtime-proof-core\n";
