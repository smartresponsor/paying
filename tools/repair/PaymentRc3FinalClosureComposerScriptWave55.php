...
$composer['scripts']['report:rc3-final-closure'] = '@php tools/php/php84.php tools/inspection/PayingRc3FinalClosureReport.php';
...
echo "Registered composer script: report:rc3-final-closure\n";
