...
if (is_file($hygieneReport)) {
    ...
    if (!str_contains($hygieneContents, "'report:rc3-milestone'") && !str_contains($hygieneContents, '"report:rc3-milestone"')) {
        $errors[] = 'Composer script hygiene report does not require report:rc3-milestone.';
    }
} else {
...
if (is_file($closureReport)) {
    ...
    if (!str_contains($closureContents, "'report:rc3-milestone'") && !str_contains($closureContents, '"report:rc3-milestone"')) {
        $errors[] = 'Runtime proof closure report does not require report:rc3-milestone.';
    }
...
echo "Status: OK\n";
echo "Milestone: RC-3 runtime proof surface is assembled and registry-covered.\n";
