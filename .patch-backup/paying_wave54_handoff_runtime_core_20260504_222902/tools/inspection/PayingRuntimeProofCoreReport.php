...
$jobs = [
    ...
    [
        'label' => 'RC-2 canonical readiness',
        'command' => paying_php_report_parts($root, 'tools/inspection/PayingCanonicalReadinessReport.php'),
        'strictZero' => true,
    ],
    [
        'label' => 'Runtime proof closure',
        'command' => paying_php_report_parts($root, 'tools/inspection/PayingRuntimeProofClosureReport.php'),
        'strictZero' => true,
    ],
    [
        'label' => 'Unit tests',
        'command' => paying_phpunit_parts($root, ['--testsuite', 'unit']),
        'strictZero' => true,
    ],
    [
        'label' => 'Functional tests',
        'command' => paying_phpunit_parts($root, ['--testsuite', 'functional']),
        'strictZero' => true,
    ],
    [
        'label' => 'Security tests',
        'command' => paying_phpunit_parts($root, ['--filter', 'PaymentScopeGuardSubscriberTest']),
        'strictZero' => true,
    ],
    [
        'label' => 'Runtime issue inventory',
        'command' => paying_php_report_parts($root, 'tools/inspection/PayingRuntimeIssueInventoryReport.php'),
        'strictZero' => false,
    ],
];
