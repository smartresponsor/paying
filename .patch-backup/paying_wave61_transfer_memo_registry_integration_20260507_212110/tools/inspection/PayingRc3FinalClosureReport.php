...
$requiredFiles = [
    ...
    'tools/inspection/PayingRc3FinalClosureReport.php',
    ...
    'docs/architecture/paying-wave55-rc3-final-closure-surface.md',
    'docs/architecture/paying-wave56-final-closure-registry-integration.md',
    'docs/architecture/paying-wave57-final-closure-self-verification.md',
    'docs/architecture/paying-wave58-final-closure-handoff-integration.md',
    'delivery/rc/paying-rc3-handoff.md',
    'delivery/rc/paying-rc3-final-closure.md',
];
...
$crossChecks = [
    ...
    ['tools/inspection/PayingComposerScriptHygieneReport.php', 'report:rc3-final-closure', 'Hygiene report must require rc3-final-closure.'],
    ...
    ['tools/inspection/PayingRuntimeProofClosureReport.php', 'PayingRc3FinalClosureReport.php', 'Closure report must require final closure report.'],
    ['tools/inspection/PayingRuntimeProofClosureReport.php', 'report:rc3-final-closure', 'Closure report must require final closure script.'],
    ['tools/inspection/PayingRc3MilestoneReport.php', 'report:rc3-handoff', 'Milestone report must require handoff script.'],
    ['tools/inspection/PayingRc3HandoffReport.php', 'report:rc3-final-closure', 'Handoff report must require final closure script.'],
    ['tools/inspection/PayingRc3HandoffReport.php', 'RC-3 final closure surface assembled', 'Handoff report must name final closure milestone.'],
    ['delivery/rc/paying-rc3-handoff.md', 'composer report:rc3-final-closure', 'Handoff memo must include final closure command.'],
    ...
    ['tools/inspection/PayingRuntimeProofCoreReport.php', 'PayingRc3FinalClosureReport.php', 'Runtime proof core must run final closure report.'],
    ['tools/inspection/PayingRuntimeProofCoreReport.php', 'RC-3 final closure', 'Runtime proof core must label final closure job.'],
];
...
echo "Status: OK\n";
echo "Milestone: RC-3 final closure surface is assembled, handoff-integrated, and self-verified.\n";
