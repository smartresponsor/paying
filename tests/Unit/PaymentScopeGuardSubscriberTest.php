 ...
 */
final class PaymentScopeGuardSubscriberTest extends TestCase
{
    ...
    {
        $verifier = $this->createMock(PaymentTokenVerifierInterface::class);
        ...
        $subscriber = new PaymentScopeGuardSubscriber($verifier, $logger);
