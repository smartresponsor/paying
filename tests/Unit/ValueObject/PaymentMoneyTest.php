 ...
 */
final class PaymentMoneyTest extends TestCase
{
    /**
    ...
    {
        $money = PaymentMoney::fromMinor(1234, 'USD');
    ...
    {
        $money = PaymentMoney::fromDecimalString('10.05', 'USD');
    ...
    public function testFromMinorRejectsInvalidCurrencyCode(): void
    {
        ...
        PaymentMoney::fromMinor(100, 'usd');
    }
    ...
    public function testFromDecimalStringRejectsInvalidFormat(): void
    {
        ...
        PaymentMoney::fromDecimalString('10', 'USD');
    }
}
