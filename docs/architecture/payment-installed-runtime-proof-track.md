...
The current slice already has strong repository ownership and proof across HTTP, UI, CLI, webhook, outbox, and QA
configuration.

The largest remaining uncertainty is no longer architecture. It is reproducible installation and execution in a real
environment.
